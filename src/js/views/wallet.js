...
'            <a href="#" data-link-section="personal_update">Хочу бонусную карту!</a>' +
'          </div>' +
'          <div id="cardDataBonus" style="display: none">' +
'            <span>Пока мы не запустили бонусную программу,<br> Ваша скидка <span id="discountValue"></span>. <br>О' +
'              начале' +
'              действия бонусной программы мы сообщим дополнительно и Вы сможете поспользоваться Вашими бонусами.</span>' +
'          </div>' +
