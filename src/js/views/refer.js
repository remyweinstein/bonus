...
export const html = '' +
'    <div id="refer" class="section refer">' +
'        <div class="container">' +
'          <div id="referQr"></div>' +
...
'            <a id="referLinkWA" href=""><img style="width: 64px;" loading="lazy" src="assets/whatsapp-128x128.png" alt="WHATSAPP"></a>' +
'            <a id="referLinkTG" href=""><img style="width: 64px;" loading="lazy" src="assets/telegram-128x128.png" alt="TELEGRAM"></a>' +
'          </p>' +
